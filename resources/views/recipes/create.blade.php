...
<section class="mt-16 flex flex-col items-center">
    ...
    <div class="max-w-3xl w-full bg-white/70 backdrop-blur-lg p-8 shadow-xl rounded-2xl border border-white/30">
        ...
        <form action="{{ route('recipes.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="title" required
                       class="w-full px-5 py-3 border rounded-xl bg-white/50 shadow-inner focus:ring-2 focus:ring-green-500 focus:outline-none">
            </div>
            ...
            <div>
                ...
                <textarea name="description" required rows="4"
                          class="w-full px-5 py-3 border rounded-xl bg-white/50 shadow-inner focus:ring-2 focus:ring-green-500 focus:outline-none"></textarea>
            </div>
            ...
            <div>
                ...
                <input type="file" name="image"
                       class="w-full border rounded-xl px-5 py-2 bg-white/50 shadow-inner focus:ring-2 focus:ring-green-500 focus:outline-none">
            </div>
