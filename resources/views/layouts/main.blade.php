        ...
        <nav class="bg-white shadow-lg fadeInTop">
			<div class="max-w-6xl mx-auto px-4">
				<div class="flex justify-between">
					<div class="flex space-x-7">
						<div>
							...
							<a href="#" class="flex items-center py-4 px-2">
								...
								<img src="{{('imgs/logo.jpg') }}" alt="Logo" class="h-12">
							</a>
						</div>
					</div>
					<!-- Secondary Navbar items -->
                        ...
                        <a href="index" class="py-4 px-2 text-base font-regular primary-color">Home</a>
						<a href="contact" class="py-4 px-2 text-base font-regular primary-color">Contact Us</a>
						<a id="nav-profile-img" href="profile" class="none md:visible"><img id="nav-profile-img-icon" class="h-9 w-9 rounded-full object-cover items-center justify-content" src="{{('imgs/defaultprofile.png') }}" /></a>
						<a id="nav-login-btn" href="login" class="py-2 px-2 text-base font-regular primary-color">Log In</a>
						<a id="nav-signup-btn" href="signup">
			...
			<div class="hidden mobile-menu">
				<ul class="">
					...
					<li class="active"><a href="index.html" class="block text-sm px-2 py-4 text-white bg-blue-600 text-base font-regular">index</a></li>
...
<section class="bg-blue-600">
		<div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
			<div class="flex justify-center mt-8 space-x-6">
				...
				<a href="https://github.com/manahmadsour" class="text-gray-50 hover:text-white">
			...
			<p class="mt-8 text-base leading-6 text-center text-gray-50">
				© 2025 TastyNest, Inc. All rights reserved.
			</p>
